...
ALTER INDEX "users_project_external_id_idx" RENAME TO "end_users_project_external_id_idx";--> statement-breakpoint
ALTER INDEX "users_project_id_idx" RENAME TO "end_users_project_id_idx";--> statement-breakpoint
...
ALTER TABLE "events" ADD CONSTRAINT "events_user_id_end_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."end_users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "member_org_id_idx" ON "member" USING btree ("organization_id");
